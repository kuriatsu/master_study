// Generated by gencpp from file ras_carla/RasObjectArray.msg
// DO NOT EDIT!


#ifndef RAS_CARLA_MESSAGE_RASOBJECTARRAY_H
#define RAS_CARLA_MESSAGE_RASOBJECTARRAY_H
...
struct RasObjectArray_
{
  typedef RasObjectArray_<ContainerAllocator> Type;

  RasObjectArray_()
    : header()
    , objects()  {
    }
  RasObjectArray_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , objects(_alloc)  {
  (void)_alloc;
    }
  ...
  _header_type header;
   ...
   typedef std::vector< ::ras_carla::RasObject_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ras_carla::RasObject_<ContainerAllocator> >::other >  _objects_type;
  ...
  typedef boost::shared_ptr< ::ras_carla::RasObjectArray_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ras_carla::RasObjectArray_<ContainerAllocator> const> ConstPtr;

}; // struct RasObjectArray_

typedef ::ras_carla::RasObjectArray_<std::allocator<void> > RasObjectArray;

typedef boost::shared_ptr< ::ras_carla::RasObjectArray > RasObjectArrayPtr;
typedef boost::shared_ptr< ::ras_carla::RasObjectArray const> RasObjectArrayConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ras_carla::RasObjectArray_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ras_carla::RasObjectArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ras_carla::RasObjectArray_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ras_carla::RasObjectArray_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ras_carla::RasObjectArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ras_carla::RasObjectArray_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ras_carla::RasObjectArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ras_carla::RasObjectArray_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ras_carla::RasObjectArray_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ras_carla::RasObjectArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfaa7b579f363a675ULL;
  static const uint64_t static_value2 = 0x827fcb235d51e316ULL;
};

template<class ContainerAllocator>
struct DataType< ::ras_carla::RasObjectArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ras_carla::RasObjectArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ras_carla::RasObjectArray_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ras_carla::RasObjectArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ras_carla::RasObjectArray_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.objects.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::ras_carla::RasObject_<ContainerAllocator> >::stream(s, indent + "    ", v.objects[i]);
    }
  }
};
...
#endif // RAS_CARLA_MESSAGE_RASOBJECTARRAY_H
