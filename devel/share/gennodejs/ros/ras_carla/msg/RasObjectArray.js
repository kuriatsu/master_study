...
class RasObjectArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.objects.forEach((val) => {
      bufferOffset = RasObject.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RasObjectArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.objects[i] = RasObject.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.objects.forEach((val) => {
      length += RasObject.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'ras_carla/RasObjectArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'faa7b579f363a675827fcb235d51e316';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RasObjectArray(null);
    ...
    if (msg.objects !== undefined) {
      ...
      for (let i = 0; i < resolved.objects.length; ++i) {
        resolved.objects[i] = RasObject.Resolve(msg.objects[i]);
      }
    }
    else {
      resolved.objects = []
